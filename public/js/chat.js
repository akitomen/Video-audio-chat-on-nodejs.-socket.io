...
contactSearch.addEventListener("keyup", function () {
  var searchVal = contactSearch.value;
    ...
    const contactList = `
        <li>
          <div class="form-check">
            <input type="checkbox" class="form-check-input" id="memberCheck${i}" name="single_contact_list" value="${contact.user_id}">
...
function deleteContact(contact_id, receiverId) {
  ...
  // document.getElementById("user-profile-sidebar").click();
  // document.querySelector(".user-profile-sidebar").style.display = "none";
  document.getElementsByClassName("chat-input-section")[0].style.display = "none";
  document.getElementById("userProfileBar").style.display = "none";
  document.getElementsByClassName("chat-welcome-section")[0].style.display = "flex";
...
socket.on("contact_delete", function ({ receiverId, userId }) {
  ...
  if (document.getElementById("s_chat_" + userId) != null) {
    document.querySelector(".user-profile-sidebar").style.display = "none";
    // document.getElementById("s_chat_" + userId).remove();
...
messageForm.addEventListener("submit", (e) => {
  ...
  if (messageId) {
    ...
    let li = document.getElementById('1stli');
    ...
    var image = `<ul class="list-inline message-img  mb-0">
                  <li class="list-inline-item message-img-list me-2 ms-0">
                      <div>
                          ...
                          `;
    if (file_upload) {
      image += `<img src='assets/images/image/${file_upload}' alt="" class="rounded border" />`;
    }
    image += `</a>
                      </div>
              ...
              <div class="ctext-wrap">
                ...
                <div class="dropdown align-self-start">
                  ...
                  <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="javascript:void(0);" onclick="singleForwordMessage(this)" data-bs-toggle="modal" data-bs-target="#forwardContact-Modal">Forward<i class="ri-chat-forward-line float-end text-muted"></i></a>
                  </div>
                </div>
              </div>
            ...
            <div class="user-chat-content">
              <div class="ctext-wrap">
                ...
                <div class="dropdown align-self-start">
                  ...
                  <div class="dropdown-menu dropdown-menu-end">
                    <a class="dropdown-item" href="javascript:void(0);" id="${id}" onclick="singleMessageCopy(this)">Copy <i
                        class="ri-file-copy-line float-end text-muted"></i></a>
                        <a class="dropdown-item" href="javascript:void(0);" id="${id}" onclick="singleMessageUpdate(this)">Edit <i class="ri-save-line float-end text-muted"></i></a>
                        <a class="dropdown-item" href="javascript:void(0);" onclick="singleForwordMessage(this)" data-bs-toggle="modal" data-bs-target="#forwardContact-Modal">Forward<i
        ...
        <li id="${user.user_id}">
            <a href="javascript:void(0);" onclick="singleChat('${user.user_id}')">
                <div class="d-flex">                            
                    ...
                    <div class="flex-1 overflow-hidden">
                        <h5 class="text-truncate font-size-15 mb-1">${user.name}<span class="typing"></span></h5>
...
// socket.on('sendUnreadMsg', ({ users }) => {
//   users.forEach(user => {
//     if (document.getElementById('s_chat_' + user.sender_id) == null) {
//       document.getElementById(user.sender_id) ? document.getElementById(user.sender_id).querySelector('.rounded-pill').innerHTML = users.length : '';
//     }
//   });
// });
...
socket.on('contactInfo', ({ contacts }) => {
  ...
  `;
    ...
    document.querySelector('.receiver_img').innerHTML = user_img;
    ...
    // document.getElementById(contact.user_id) ? document.getElementById(contact.user_id).querySelector('.rounded-pill').innerHTML = '' : '';
...
function CharacterData(id, name) {
  ...
  socket.on("receiverMessageInfo", ({ users }) => {
    document.querySelector(".receiver_messageData").innerHTML = "";
    users.forEach((user) => {
      var extName = user.file_upload.split(".").pop();
      if ("png,jpg,jpeg".includes(extName)) {
      ...
      var image = `<div class="avatar-sm me-3 ms-0">
                        <div class="avatar-title bg-soft-primary text-primary rounded font-size-20">
                          ${icon}
                        </div>
                      </div>`;
...
let adduchat = (users, receiverName) => {
  ...
  users.forEach((user, index) => {
    ...
    var receiver_image = user.image[0]
      ? `<img src="assets/images/users/${user.image[0]}" alt="" class="user-profile-image user-profile-image">`
      ...
      var image = `<ul class="list-inline message-img  mb-0">
                    <li class="list-inline-item message-img-list me-2 ms-0">
                        <div>
                            ...
                            `;
      if (user.file_upload) {
        image += `<img src='assets/images/image/${user.file_upload}' alt="" class="rounded border" />`;
      }
      image += `</a>
                        </div>
                        <div class="message-img-link">
            ...
            <div class="chat-avatar">${receiver_image}</div>
              <div class="user-chat-content">
                <div class="ctext-wrap">
                  <div class="ctext-wrap-content">
                    <div style="display:${none}">${image}</div>
                    <p class="mb-0 single_message text-break">${user.message}</p>
                    <p class="chat-time mb-0"><i class="ri-time-line align-middle"></i> <span
                  ...
                  <div class="dropdown align-self-start">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                      <a class="dropdown-item" href="javascript:void(0);" id="${user._id}" onclick="singleMessageCopy(this)">Copy <i
                          class="ri-file-copy-line float-end text-muted"></i></a>
                          <a class="dropdown-item" href="javascript:void(0);" onclick="singleForwordMessage(this)" data-bs-toggle="modal" data-bs-target="#forwardContact-Modal">Forward<i
                          class="ri-chat-forward-line float-end text-muted"></i></a>
                    </div>
              ...
              <div class="ctext-wrap">
                ...
                <div class="dropdown align-self-start">
                  ...
                  <div class="dropdown-menu dropdown-menu-end">
                    <a class="dropdown-item" href="javascript:void(0)" id="${user._id}" onclick="singleMessageCopy(this)">Copy <i
                        class="ri-file-copy-line float-end text-muted"></i></a>
                    <a class="dropdown-item" href="javascript:void(0);" id="${user._id}" onclick="singleMessageUpdate(this)">Edit <i class="ri-save-line float-end text-muted"></i></a>
                    <a class="dropdown-item" href="javascript:void(0);" onclick="singleForwordMessage(this)" data-bs-toggle="modal" data-bs-target="#forwardContact-Modal">Forward<i
                        class="ri-chat-forward-line float-end text-muted"></i></a>
...
function singleForwordMessage(messages) {
  // upload_img = messages.parentElement.parentElement.parentElement.querySelector("span.upload_img").innerText;
  copy_text = messages.parentElement.parentElement.parentElement.querySelector("p.single_message").innerText;
}
              ...
              <div class="ctext-wrap">
                ...
                <div class="dropdown align-self-start">
                  ...
                  <div class="dropdown-menu dropdown-menu-end">
                      ...
                      class="ri-file-copy-line float-end text-muted"></i></a>
                      <a class="dropdown-item" href="javascript:void(0);" id="${user}" onclick="singleForwordMessage(this)" data-bs-toggle="modal" data-bs-target="#forwardContact-Modal">Forward <i
                      class="ri-chat-forward-line float-end text-muted"></i></a>
                  </div>
                </div>
              </div>
...
function contact_group(groupsId, groupName, userId) {
  ...
  // document.querySelector(".add_contact").setAttribute("id", groupsId);
...
socket.on("groupInfo", ({ group }) => {
  ...
  const userBox = `
    ...
    <span class="avatar-title rounded-circle bg-soft-primary text-primary group_img">${group.name[0]}</span>
    </div>
    <div class="flex-1 overflow-hidden">
      <h5 class="font-size-16 mb-0 text-truncate message_typing"><a href="javascript:void(0)" class="text-reset user-profile-show receiver_name" onclick="profile_show(this.id)">${group.name}</a> <i class="ri-record-circle-fill font-size-10 text-success d-inline-block ms-1"></i>
      </h5>
      <span class="typing_${group._id}"></span>
      <h6>${group._id}</h6>
    </div>
  `;
  userChat.innerHTML = userBox;
  ...
  document.querySelector(".receiver_img").innerHTML = `<div class="avatar-xs mx-auto"><span class="avatar-title rounded-circle bg-soft-primary text-primary group_img">${group.name[0]}</span></div>`;
  var receiverName = document.querySelectorAll(".receiver_name");
  Array.from(receiverName).forEach((element, index) => {
    element.innerHTML = group.name;
  });
...
let addgchat = groups => {
  ...
  groups.forEach((group) => {
    ...
    const createdAt =
      ...
      ":" +
      time.getMinutes();
    var receiver_image = group.image[0]
      ? `<img src="assets/images/users/${group.image[0]}" alt="">`
      : `<div class="avatar-xs"><span class="avatar-title rounded-circle bg-soft-primary text-primary">${group.name[0][0]}</span></div>`;
    ...
    if (!imgList.includes(extName)) {
      ...
      if (group.file_upload) {
        image += `<img src='assets/images/image/${group.file_upload}' alt="" class="rounded border" />`;
      }
      image += `</a>
                            </div>
                            <div class="message-img-link">
          ...
          <div class="conversation-list">
            ...
            <div class="user-chat-content">
              <div class="ctext-wrap">
                <div class="ctext-wrap-content">
                  <div style="display:${none}">${image}</div>
                  <p class="mb-0 single_message text-break">${group.message}</p>
                  <p class="chat-time mb-0"><i class="ri-time-line align-middle"></i> <span
                      class="align-middle">${createdAt}</span></p>
                </div>
                <div class="dropdown align-self-start">
                  ...
                  <div class="dropdown-menu dropdown-menu-end">
                    <a class="dropdown-item" href="javascript:void(0)" id="${group._id}" onclick="groupMessageCopy(this)">Copy <i class="ri-file-copy-line float-end text-muted"></i></a>
                    <a class="dropdown-item" href="javascript:void(0);" id="${userId}" onclick="singleForwordMessage(this)" data-bs-toggle="modal" data-bs-target="#forwardContact-Modal">Forward <i class="ri-chat-forward-line float-end text-muted"></i></a>
                  </div>
                </div>
              </div>
            ...
            <div class="user-chat-content">
              <div class="ctext-wrap">
                ...
                <div class="dropdown align-self-start">
                  ...
                  <div class="dropdown-menu dropdown-menu-end">
                    <a class="dropdown-item" href="javascript:void(0)" id="${group._id}" onclick="groupMessageCopy(this)">Copy <i
                        class="ri-file-copy-line float-end text-muted"></i></a>
                        <a class="dropdown-item" href="javascript:void(0);" id="${group._id}" onclick="multiMessageUpdate(this)">Edit <i class="ri-save-line float-end text-muted"></i></a>
                        <a class="dropdown-item" href="javascript:void(0);" id="${userId}" onclick="singleForwordMessage(this)" data-bs-toggle="modal" data-bs-target="#forwardContact-Modal">Forward <i
                        class="ri-chat-forward-line float-end text-muted"></i></a>
    ...
    // messageBox.innerHTML += userId === group.sender_id ? myMsg : receivedMsg;
...
socket.on("deleteGroupUser", function ({ id, group_id }) {
  if (id == userId) {
    ...
    if (document.getElementById("g_chat_" + group_id) != undefined) {
      // document.getElementById("contact_list_" + id) ?
      //  : '';
      document.getElementsByClassName("chat-conversation")[0].style.display = "none";
      document.getElementById("userProfileBar").style.display = "none";
      document.querySelector(".user-profile-sidebar").style.display = "none";
    ...
    // document.getElementById("contact_list_" + id).remove() 
  }
});
...
function scrollToBottom() {
  var simpleBar = document.querySelector(
    "#messageBody .simplebar-content-wrapper"
  );
  var offsetHeight = document.getElementsByClassName("messages__history")[0]
    ? document.getElementsByClassName("messages__history")[0].scrollHeight -
    window.innerHeight +
    250
    : 0;
  if (offsetHeight)
...
socket.on('cutphoness', () => {
  // document.getElementById('closeincomingmodel').click();
  cutingphone = true;
  document.getElementById(`cutincomingmodel`).click();
  callerring.pause();
  callerring.currentTime = 0;
...
socket.on("ringcalling", (uid, icid, name, image, ctype) => {
  if (!isactive) {
    cutingphone = false
    // image = image ? image : 'default_image.jpg';
...
click_button.addEventListener('click', function () {
  ...
  var image = `<img src='${image_data_url}' class='profile-user rounded' width=350px>`;
